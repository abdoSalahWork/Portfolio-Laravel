                    ...
                    <div class="row">
                        <form control="" class="" method="POST" action="{{route('admin.login')}}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" name="email" id="username" class="form__input bg-white" placeholder="E-mail">
                            </div>
                            <div class="col-12">
                                <!-- <span class="fa fa-lock"></span> -->
                                <input type="password" name="password" id="password" class="form__input bg-white" placeholder="Password">
                            </div>
                            <div class="row">
                                <div class="col-5">
