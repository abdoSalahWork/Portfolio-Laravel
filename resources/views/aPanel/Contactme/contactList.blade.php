...
<div class="container">
    ...
    <div class="col-10 mx-auto card p-2 mb-3">
            ...
            <div class="card card-danger p-1">
                <div class="card-body">
                    <div class="row justify-content-center  py-2">
                        ...
                        <button class="btn btn-info " name="skillAddSubmit">add Contact</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="card-header">
            <h3 class="card-title">Contacts Full List</h3>
        </div>
        <!-- /.card-header -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 180px;">
                            <a href="#editEmployeeModal{{$contact['id']}}" class="edit" data-toggle="modal" title="Edit">
                                <i class="text-warning  far fa-edit fa-2x" data-toggle="tooltip"></i>
                            </a>
                        </td>
                        <td>
                            <a href="#deleteEmployeeModal{{$contact['id']}}" class="delete ml-2" data-toggle="modal">
                                <i class="text-danger far fa-trash-alt fa-2x" data-toggle="tooltip" title="Delete"></i>
                            </a>
                        </td>
                        <!-- Edit Modal HTML -->
                        <div id="editEmployeeModal{{$contact['id']}}" class="modal fade">
                        ...
                        <!-- Delete Modal HTML -->
                        <div id="deleteEmployeeModal{{$contact['id']}}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
