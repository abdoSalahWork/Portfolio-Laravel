...
<div class="container">
    ...
    <div class="col-8 mx-auto card p-2 mb-3">
            ...
            <div class="card card-danger p-3">
                <div class="card-body">
                    <div class="row justify-content-center py-2">
                        ...
                        <div class="col-8">
                            <input type="text"  name="name" class="form-control" id="productCategory">
                        </div>
        ...
        <div class="card-header">
            <h3 class="card-title">Portfolio Full List</h3>
        </div>
        <!-- /.card-header -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div id="editEmployeeModal{{$category['id']}}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post" action="{{route('admin.portfolio.category.update',[$category->id])}}">
                                        @csrf
                                        @method('PUT')
                        ...
                        <div id="deleteEmployeeModal{{$category['id']}}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post" action="{{route('admin.portfolio.category.delete',[$category->id])}}">
                                        @csrf
                                        @method('DELETE')
                                        <div class="modal-header">
